...
public class Get07 extends JsonplaceholderBaseUrl {
    ...
    public void get07() {
        ...
        List<Integer> idler = json.getList("findAll{it.id>190}.id"); // hepsini bul id'si 190'dan buyuk olanlari getir
                                                                           // Groovy Language = Java temelli programlama dili
        System.out.println("id'si 190'dan buyuk olan id'ler => " + idler);
        ...
        System.out.println("Id'si 5 den kucuk olanlarin userIdler' -> " + userId);

        // ==> id si 5 den kucuk olan 4 tane userId oldugunu dogrulayin
        assertEquals("Id'si 5'den kucuk olan UserId ler 4 tane degil", 4, userId.size());
        ...
        assertTrue("id'si 5'ten kucuk olan Title'lardan herhangi birisi  \"delectus aut autem\" icermemektedir",
